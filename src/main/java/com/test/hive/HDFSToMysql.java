...
public class HDFSToMysql {
	...
	public static void sqoopTransfer() {
		//初始化
		String url = "http://192.168.56.122:12000/sqoop/";
		...
		fromLinkConfig.getStringInput("linkConfig.uri").setValue("hdfs://cluster1:9000/user/hive/warehouse/hive_mysql");
		...
		toLinkConfig.getStringInput("linkConfig.connectionString").setValue("jdbc:mysql://192.168.56.122:3306/hive");
