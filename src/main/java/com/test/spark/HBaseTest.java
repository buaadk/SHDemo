...
import com.test.spark.vo.Person;
...
public class HBaseTest {
    ...
    static {
        ...
        conf.set("hbase.master", "cluster1:60000");
    ...
    public static void main(String[] args) {
        ...
        SparkConf conf1 = new SparkConf().setAppName(
                ...
                "spark://cluster1:7077").set("spark.serializer", "org.apache.spark.serializer.KryoSerializer")
